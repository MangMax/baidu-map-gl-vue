...
import BZoom from '../../packages/vue3-baidu-map-gl/src/components/controls/BZoom.vue'
import BScale from '../../packages/vue3-baidu-map-gl/src/components/controls/BScale.vue'
import BCityList from '../../packages/vue3-baidu-map-gl/src/components/controls/BCityList.vue'
import BLocation from '../../packages/vue3-baidu-map-gl/src/components/controls/BLocation.vue'
import BNavigation3d from '../../packages/vue3-baidu-map-gl/src/components/controls/BNavigation3d.vue'
import BCopyright from '../../packages/vue3-baidu-map-gl/src/components/controls/BCopyright.vue'
