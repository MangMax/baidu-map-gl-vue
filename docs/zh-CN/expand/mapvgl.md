...
[#43](https://github.com/Mang-X/bmap-vue/issues/43)）。大面积散点/线面请看原生数据
图层方向（[#35](https://github.com/Mang-X/bmap-vue/issues/35) /
[#36](https://github.com/Mang-X/bmap-vue/issues/36)）。
:::
